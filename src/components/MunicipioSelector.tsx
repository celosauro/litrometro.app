  ...
  return (
    <div className="relative w-full sm:w-auto sm:min-w-[180px]">
      <select
        ...
        className="w-full appearance-none pl-3 pr-8 sm:pl-4 sm:pr-10 py-2 text-sm sm:text-base border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-brand-500 focus:border-transparent cursor-pointer"
      >
