      ...
      <article className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 sm:p-8">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mt-4 mb-3">Cookies Essenciais:</h3>
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
              <li>Lembrar suas preferências de consentimento</li>
              <li>Manter o funcionamento adequado do site</li>
            </ul>

            <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mt-4 mb-3">Cookies de Análise (Google Analytics):</h3>
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
            ...
            <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200 mt-4 mb-3">Cookies de Publicidade (Google AdSense):</h3>
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
              <li>
                <strong className="dark:text-white">Google Analytics:</strong> Para entender o comportamento dos usuários 
                e melhorar o site. Os dados são anonimizados e agregados.
              </li>
              <li>
                <strong className="dark:text-white">Google AdSense:</strong> Para exibir anúncios que ajudam a manter 
