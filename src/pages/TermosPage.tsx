    ...
    <main className="max-w-4xl mx-auto px-4 py-8 sm:py-12 flex-1">
      <article className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 sm:p-8">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              <Warning size={28} className="text-amber-600 dark:text-amber-400" />
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white m-0">
                Isenção de Responsabilidade
              </h2>
            </div>
            ...
            <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-lg p-4 mb-4">
              <p className="text-amber-800 dark:text-amber-200 font-medium mb-2">Importante:</p>
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              O Litrômetro <strong className="dark:text-white">não garante</strong>:
            </p>
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
              <li>
                <strong className="dark:text-white">Precisão dos preços atuais:</strong> Os preços podem ter sido 
                alterados pelo estabelecimento após a última venda registrada no sistema 
                da SEFAZ/AL.
              </li>
              <li>
                <strong className="dark:text-white">Disponibilidade do combustível:</strong> O combustível pode estar 
                em falta no momento da sua visita ao estabelecimento.
              </li>
              <li>
                <strong className="dark:text-white">Qualidade do serviço dos postos:</strong> Não avaliamos nem 
                endossamos a qualidade do atendimento ou dos combustíveis vendidos.
              </li>
              <li>
                <strong className="dark:text-white">Exatidão das coordenadas:</strong> A localização dos 
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              <strong className="dark:text-white">Dados de preços:</strong> Os dados de preços de combustíveis são de 
          ...
          {/* Contato */}
          <section className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6 mt-8">
